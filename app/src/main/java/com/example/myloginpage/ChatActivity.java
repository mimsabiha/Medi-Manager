...
import com.example.myloginpage.chatbot.BotReply;
import com.example.myloginpage.chatbot.ChatAdapter;
import com.example.myloginpage.chatbot.Message;
import com.example.myloginpage.chatbot.SendMessageInBg;
...
public class ChatActivity extends AppCompatActivity implements BotReply {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ColorDrawable colorDrawable
                = new ColorDrawable(Color.parseColor("#00BED6"));
    ...
    //chatbot voice messeging recognizer function
    private void speak() {
    ...
    // returning response function of chatbot
    @Override
