...
public class TextRecognition extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scanResult  = findViewById(R.id.scan_result_Id);
   ...
   /* @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_text_recognition, menu);
        return true;
    }*/
    ...
    /*private void dialogAbout() {
        new AlertDialog.Builder(this)
                .setTitle("About App")
                .setMessage("This app is made by Sabiha.")
    ...
    // scan image button activity
    @Override
    public void onClick(View v) {
        if(v.getId()==R.id.scan_result_Id){
            showImageImportDialog();

        }
    }
    //providing image import dialog
    ...
    //handling crop image activity result
    @Override
